...
INPUT_JSON_PATH = './test_sets/ka_test.blind.json'
OUTPUT_JSON_PATH = './preds/ka_preds_2-task2.json'
...
def create_prompt(raw_text):
    return f"""
### ინსტრუქციები:
თქვენ ფრანგული ენის მშობლიური ენა ხართ. გადაწერეთ წინადადება ქვემოთ მოცემული ნაბიჯების მიხედვით:

- ყურადღებით წაიკითხეთ წინადადება და დარწმუნდით, რომ სრულად გესმით მისი მნიშვნელობა.

- საკუთარი სიტყვებით გამოხატეთ წინადადების მთავარი იდეა: გამოიყენეთ სინონიმები, შეცვალეთ სტრუქტურა და გრამატიკა.

- შეადარეთ თქვენი გადაწერილი წინადადება ორიგინალურ წინადადებას, რათა დარწმუნდეთ, რომ მნიშვნელობა შენარჩუნებულია.
თქვენი პასუხი შემდეგნაირად დააფორმატეთ:
გადაწერილი არის:
