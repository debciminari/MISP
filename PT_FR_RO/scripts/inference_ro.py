...
OUTPUT_JSON_PATH = './preds/ro_preds.json'
...
def create_prompt(raw_text):
    return f"""Mai jos veți găsi instrucțiuni care descriu o sarcină, împreună cu câteva informații de bază.
    Scrieți un răspuns care să răspundă corect la întrebare. Înainte de a răspunde, gândiți-vă cu atenție la întrebare pentru a vă asigura exactitatea răspunsului.

    ### Instrucțiuni:
    Ești vorbitor nativ de limba română. Următoarea propoziție conține o expresie idiomatică.
